    ...
    <body>
        ...
        <form id="deleteForm" action="/task/delete/{{ $task->id }}" method="POST">
            ...
            <div class="button-container">
                ...
                <button type="button" class="btn-cancel" onclick="window.location.href='/task'">Cancel</button>
            </div>
